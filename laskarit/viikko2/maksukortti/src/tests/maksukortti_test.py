...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahenta_saldoa_oikein(self):
    ...
    def test_syo_edullisesti_toimii_kun_tarpeeksi_rahaa(self):
        kortti2 = Maksukortti(2.5)
        kortti2.syo_edullisesti()
        self.assertEqual(str(kortti2), "Kortilla on rahaa 0.0 euroa")

    def test_syo_maukkaasti_toimii_kun_tarpeeksi_rahaa(self):
        kortti2 = Maksukortti(4)
        kortti2.syo_maukkaasti()
        self.assertEqual(str(kortti2), "Kortilla on rahaa 0 euroa")

    def test_syo_edullisesti_ei_toimi_kun_ei_tarpeeksi_rahaa(self):
        kortti2 = Maksukortti(2.49)
        kortti2.syo_edullisesti()
        self.assertEqual(str(kortti2), "Kortilla on rahaa 2.49 euroa")

    def test_syo_maukkaasti_ei_toimi_kun_ei_tarpeeksi_rahaa(self):
        kortti2 = Maksukortti(3.99)
        kortti2.syo_maukkaasti()
        self.assertEqual(str(kortti2), "Kortilla on rahaa 3.99 euroa")
