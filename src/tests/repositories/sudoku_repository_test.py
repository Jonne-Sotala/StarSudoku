...
class TestSudokuRepository(unittest.TestCase):
    def setUp(self):
        ...
        self.sudoku1 = Sudoku('800930002009000040702100960200000090060000070070006005027008406030000500500062008',
                              '846937152319625847752184963285713694463859271971246385127598436638471529594362718',
                              'easy')
        self.sudoku2 = Sudoku('000006080009105372080700016000000034000351000730000000610008020823904600070600000',
                              '157236489469185372382749516591867234246351798738492165614578923823914657975623841',
                              'easy')
        self.sudoku3 = Sudoku('009000000427060098000290370005000030003519600040000200032076000850030724000000900',
